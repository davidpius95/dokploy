...
const TEMPLATE_BASE_URL_KEY = "guildserver_template_base_url";
							...
							>
								{templates?.map((template) => (
									...
									>
										...
										>
											<img
												src={`${customBaseUrl || "https://raw.githubusercontent.com/dokploy/templates/main"}/blueprints/${template?.id}/${template?.logo}`}
												className={cn(
													"object-contain",
