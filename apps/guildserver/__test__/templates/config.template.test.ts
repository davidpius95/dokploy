import type { Schema } from "@guildserver/server/templates";
import type { CompleteTemplate } from "@guildserver/server/templates/processors";
import { processTemplate } from "@guildserver/server/templates/processors";
