...
// Paystack integration - no client-side SDK needed
        ...
        <div className="rounded-xl bg-background shadow-md ">
          ...
          <CardContent className="space-y-2 py-8 border-t">
            <div className="flex flex-col gap-4 w-full">
              ...
              {admin?.user.paystackSubscriptionId && (
                                  ...
                                  onClick={async () => {
                                    try {
                                      ...
                                      if (url) {
                                        ...
                                        toast.error(
                                          "Could not open Paystack portal. Please try again later."
                                        );
                                      }
                                    } catch (e) {
                                      toast.error(
                                        "Failed to create Paystack portal session."
                                      );
                                      console.log(e);
                                    }
                                  }}
